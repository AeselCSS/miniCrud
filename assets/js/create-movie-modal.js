...
function showAddMovieModal() {
	...
	const html = /*html*/ `
        ...
        <form id="form" class="dialog-create-movie">
          ...
          <input type="text" id="title" name="title" placeholder="Title of movie"/>
          
		  <label for="runtime">Movie length:</label>
          <input
            type="number" id="runtime" name="runtime" placeholder="Runtime in minutes"/>
         
		  <label for="score">Score:</label>
          <input type="number" id="score" name="score" placeholder="Rate between 0,0-10" min="0" max="10" step="0.1"/>
          
		  <label for="director">Director:</label>
          <input type="text" id="director" name="director" placeholder="Director"/>
          
		  <label for="actors">Star Actors:</label>
          <input type="text" id="actors" name="actorStars" placeholder="Name of star actors (actor1, actor2, ...)"/>
          
		  <label for="year">Year of premiere:</label>
          <input type="number" id="year" name="year" placeholder="Year of release"/>
          
		  <label for="poster">Poster:</label>
          <input type="url" id="poster" name="poster" placeholder="URL link" />
         
		  <label for="trailer">Trailer:</label>
          <input type="url" id="trailer" name="trailer" placeholder="URL link"/>
          
		  <label for="genre">Genre:</label>
          <input type="text" id="genre" name="genreTags" placeholder="Write the genre (genre1, genre2, ...)"/>
  ...
  `;
	...
	// add eventlisteners to all input fields to validate input
...
async function createMovieClicked(event) {
	...
	// if response is ok, call updateGrid to update the grid with the new movie data else display error message
	if (response.ok) {
